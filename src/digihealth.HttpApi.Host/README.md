...
If you previously seeded the database when the Swagger client still had a secret, rerun the `digihealth.DbMigrator` project to update the OpenIddict application to the public, secret-less configuration.
