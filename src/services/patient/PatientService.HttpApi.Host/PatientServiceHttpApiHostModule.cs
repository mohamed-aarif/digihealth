...
public class PatientServiceHttpApiHostModule : AbpModule
{
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        Configure<PatientServiceSeedDataOptions>(configuration.GetSection("PatientService:SeedData"));
    ...
    private static void ConfigureAuthentication(ServiceConfigurationContext context, IConfiguration configuration)
    {
        context.Services.AddAuthentication(JwtBearerDefaults.AuthenticationScheme)
            .AddJwtBearer(options =>
            {
                ...
                options.Audience = configuration["AuthServer:Audience"] ?? "PatientService";
            });
    }
}
