    ...
    public partial class InitialPatientService : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_patient_external_links_IdentityPatientId_SystemName_TenantId",
                schema: "patient",
                table: "patient_external_links",
                columns: new[] { "IdentityPatientId", "SystemName", "TenantId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_patient_medical_summaries_IdentityPatientId_TenantId",
                schema: "patient",
                table: "patient_medical_summaries",
                columns: new[] { "IdentityPatientId", "TenantId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_patient_profile_extensions_IdentityPatientId_TenantId",
                schema: "patient",
