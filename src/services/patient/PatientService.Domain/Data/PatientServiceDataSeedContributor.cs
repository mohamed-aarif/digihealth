...
public class PatientServiceDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    // Must match IdentityServiceDataSeedContributor.DemoPatientId
    ...
    public async Task SeedAsync(DataSeedContext context)
    {
        ...
        if (await _linkRepository.FirstOrDefaultAsync(
                x => x.IdentityPatientId == DemoPatientId && x.SystemName == "HospitalEMR") == null)
        {
