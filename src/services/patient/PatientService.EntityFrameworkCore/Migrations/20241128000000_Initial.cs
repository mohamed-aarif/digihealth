    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PatientExternalLinks", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "PatientMedicalSummaries",
                schema: "patient",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PatientMedicalSummaries", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "PatientProfileExtensions",
                schema: "patient",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PatientProfileExtensions", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_PatientExternalLinks_IdentityPatientId_SystemName",
                schema: "patient",
                table: "PatientExternalLinks",
                columns: new[] { "IdentityPatientId", "SystemName" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PatientMedicalSummaries_IdentityPatientId",
                schema: "patient",
                table: "PatientMedicalSummaries",
                column: "IdentityPatientId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PatientProfileExtensions_IdentityPatientId",
                schema: "patient",
                table: "PatientProfileExtensions",
                column: "IdentityPatientId",
                unique: true);
        }
