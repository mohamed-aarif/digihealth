        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    status = table.Column<int>(type: "appointments.appointment_status", nullable: false, defaultValueSql: "'Planned'::appointments.appointment_status"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    actor_type = table.Column<int>(type: "consent.actor_type", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_consent_sessions", x => x.id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    linked_at = table.Column<DateTime>(type: "timestamp without time zone", nullable: false, defaultValueSql: "NOW()"),
                    is_active = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    channel = table.Column<int>(type: "engagement.channel_type", nullable: false),
                    template_key = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: true),
                    payload_json = table.Column<string>(type: "jsonb", nullable: false),
                    status = table.Column<int>(type: "engagement.notification_status", nullable: false, defaultValueSql: "'Pending'::engagement.notification_status"),
                    created_at = table.Column<DateTime>(type: "timestamp without time zone", nullable: false, defaultValueSql: "NOW()"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false, defaultValueSql: "gen_random_uuid()"),
                    patient_id = table.Column<Guid>(type: "uuid", nullable: false),
                    record_type = table.Column<int>(type: "vault.record_type", nullable: false),
                    title = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    description = table.Column<string>(type: "text", nullable: true),
                    file_storage_key = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: false),
                    sensitivity = table.Column<int>(type: "vault.sensitivity_level", nullable: false, defaultValueSql: "'Restricted'::vault.sensitivity_level"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false, defaultValueSql: "gen_random_uuid()"),
                    patient_id = table.Column<Guid>(type: "uuid", nullable: false),
                    event_type = table.Column<int>(type: "vault.event_type", nullable: false),
                    related_id = table.Column<Guid>(type: "uuid", nullable: true),
                    event_time = table.Column<DateTime>(type: "timestamp without time zone", nullable: false, defaultValueSql: "NOW()"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ai_visit_briefs", x => x.id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    sender = table.Column<int>(type: "engagement.message_sender", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    accessed_at = table.Column<DateTime>(type: "timestamp without time zone", nullable: false, defaultValueSql: "NOW()"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    vital_type = table.Column<int>(type: "devices.vital_type", nullable: false),
                    ...
                    taken_at = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    created_at = table.Column<DateTime>(type: "timestamp without time zone", nullable: false, defaultValueSql: "NOW()")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_patient_identifiers", x => x.id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_medication_items", x => x.id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    status = table.Column<int>(type: "medication.dose_status", nullable: false, defaultValueSql: "'Scheduled'::medication.dose_status"),
                    taken_at = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    notes = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_access_logs_consent_session_id",
                schema: "consent",
                table: "access_logs",
                column: "consent_session_id");

            migrationBuilder.CreateIndex(
                name: "IX_ai_visit_briefs_appointment_id",
                schema: "appointments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_chat_sessions_patient_id",
                schema: "engagement",
                table: "chat_sessions",
                column: "patient_id");

            migrationBuilder.CreateIndex(
                name: "IX_consent_sessions_actor_user_id",
                schema: "consent",
                table: "consent_sessions",
                column: "actor_user_id");

            migrationBuilder.CreateIndex(
                name: "IX_consent_sessions_patient_id",
                schema: "consent",
                table: "consent_sessions",
                column: "patient_id");

            migrationBuilder.CreateIndex(
                name: "IX_device_links_patient_id",
                schema: "devices",
                table: "device_links",
                column: "patient_id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_family_links_patient_id",
                schema: "identity",
                table: "family_links",
                column: "patient_id");

            migrationBuilder.CreateIndex(
                name: "IX_medication_doses_schedule_id",
                schema: "medication",
                table: "medication_doses",
                column: "schedule_id");

            migrationBuilder.CreateIndex(
                name: "IX_medication_items_prescription_id",
                schema: "medication",
                table: "medication_items",
                column: "prescription_id");

            migrationBuilder.CreateIndex(
                name: "IX_medication_schedules_medication_item_id",
                schema: "medication",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_patient_identifiers_record_id",
                schema: "identity",
                table: "patient_identifiers",
                column: "record_id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_patient_insurances_record_id",
                schema: "identity",
                table: "patient_insurances",
                column: "record_id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_records_patient_id",
                schema: "vault",
                table: "records",
                column: "patient_id");

            migrationBuilder.CreateIndex(
                name: "IX_timeline_events_patient_id",
                schema: "vault",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_visit_notes_appointment_id",
                schema: "appointments",
                table: "visit_notes",
                column: "appointment_id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_vital_readings_device_link_id",
                schema: "devices",
                table: "vital_readings",
