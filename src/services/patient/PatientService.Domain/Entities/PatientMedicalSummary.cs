...
public class PatientMedicalSummary : FullAuditedAggregateRoot<Guid>, IMultiTenant
{
        ...
        string? notes) : base(id)
    {
        ...
        UpdateMedicalSummary(bloodGroup, allergies, chronicConditions, notes);
    }

    public void UpdateMedicalSummary(string? bloodGroup, string? allergies, string? chronicConditions, string? notes)
    {
