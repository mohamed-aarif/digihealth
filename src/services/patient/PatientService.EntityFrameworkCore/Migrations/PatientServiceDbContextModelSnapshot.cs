...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PatientService.Entities.PatientExternalLink", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("IdentityPatientId", "SystemName", "ExternalReference")
                        .IsUnique();

                    b.ToTable("patient_external_links", "patient");
                });

            modelBuilder.Entity("PatientService.Entities.PatientMedicalSummary", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PatientService.Entities.PatientProfileExtension", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("patient_profiles", "patient");
                });
